...
MainWindow::MainWindow(int size, QWidget *parent) : QMainWindow(parent){
    ...
    PointList curve4 {{75.0,250.0},{150.0,150.0},{400.0,100.0},{700.0,175.0},{600.0,350.0},{500.0,350.0}};

    tabWidget->addTab(new BezierFrame(QSize(size,size),{curve1,curve2,curve3}),QString("Bezier curves"));

    tabWidget->addTab(new BSplineFrame(QSize(size,size),{curve4}),QString("B-Spline curves"));
